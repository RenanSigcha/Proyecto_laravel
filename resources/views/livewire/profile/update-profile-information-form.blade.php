...
new class extends Component
{
    ...
    public function mount(): void
    {
        ...
        $this->correo_electronico = Auth::user()->correo_electronico;
    }
    ...
    public function updateProfileInformation(): void
    {
        ...
        $validated = $this->validate([
            ...
            'correo_electronico' => ['required', 'string', 'lowercase', 'email', 'max:255', Rule::unique(User::class)->ignore($user->id, 'id')],
        ]);

        $user->fill($validated);

        if ($user->isDirty('correo_electronico')) {
...
<section>
    ...
    <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input wire:model="correo_electronico" id="correo_electronico" name="correo_electronico" type="email" class="mt-1 block w-full" required autocomplete="email" />
