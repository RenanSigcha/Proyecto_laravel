<?php
    ...
    $ventasHoy = Pedido::where('payment_status', 'completed')
        ->whereDate('created_at', today())
        ->sum('total_a_pagar');
    $ventasTotal = Pedido::where('payment_status', 'completed')
        ->sum('total_a_pagar');
?>
    ...
    <div class="px-6 py-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">
                        Bienvenido, <span class="font-semibold text-gray-900"><?php echo e(auth()->user()->nombre); ?> <?php echo e(auth()->user()->apellido); ?></span>
                    </p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-gray-500"><?php echo e(now()->format('l, j \\d\\e F \\d\\e Y')); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border-t-4 border-blue-500">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-4xl font-bold text-gray-900 mt-3"><?php echo e($totalProductos); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border-t-4 border-green-500">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-4xl font-bold text-gray-900 mt-3"><?php echo e($totalPedidos); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border-t-4 border-purple-500">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-4xl font-bold text-gray-900 mt-3"><?php echo e($totalClientes); ?></p>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border-t-4 border-orange-500">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-4xl font-bold text-gray-900 mt-3">$<?php echo e(number_format($ventasHoy, 2)); ?></p>
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl shadow-lg p-8">
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="border-b-2 border-green-200 pb-4">
                        ...
                        <p class="text-4xl font-bold text-green-600 mt-3">$<?php echo e(number_format($ventasTotal, 2)); ?></p>
                    ...
                    <div class="border-b-2 border-blue-200 pb-4">
                        ...
                        <p class="text-4xl font-bold text-blue-600 mt-3">
                            $<?php echo e($totalPedidos > 0 ? number_format($ventasTotal / $totalPedidos, 2) : '0.00'); ?>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <!-- Productos -->
                <a href="<?php echo e(route('admin.productos')); ?>" class="group bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 border-2 border-blue-300 rounded-2xl p-6 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                ...
                <!-- Pedidos -->
                <a href="<?php echo e(route('admin.pedidos')); ?>" class="group bg-gradient-to-br from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 border-2 border-green-300 rounded-2xl p-6 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                    <div class="flex items-center mb-3">
                ...
                <!-- Reportes -->
                <a href="<?php echo e(route('admin.reportes')); ?>" class="group bg-gradient-to-br from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 border-2 border-purple-300 rounded-2xl p-6 transition-all duration-300 transform hover:scale-105 hover:shadow-lg">
                    <div class="flex items-center mb-3">
...
<?php /**PATH C:\xampp\htdocs\Renan\resources\views/components/admin/dashboard.blade.php ENDPATH**/ ?>